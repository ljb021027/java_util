...
public class WordCountLambdaExample {
  ...
  static final String inputTopic = "streams-plaintext-input1";
  static final String outputTopic = "streams-wordcount-output1";
  ...
  static Properties getStreamsConfiguration(final String bootstrapServers) {
    ...
    streamsConfiguration.put(StreamsConfig.APPLICATION_ID_CONFIG, "wordcount-lambda-example2");
    streamsConfiguration.put(StreamsConfig.CLIENT_ID_CONFIG, "wordcount-lambda-example-client2");
...
//      .count();
    ...
    KTable<Windowed<String>, Long> wordCounts = textLines
            .flatMapValues(value -> Arrays.asList(value.toLowerCase().split("\\W+"))).groupByKey()
...
//    wordCounts.toStream().print(Printed.<String, Long>toSysOut().withLabel("patterns"));

    wordCounts.toStream().print(Printed.<Windowed<String>, Long>toSysOut().withLabel("patterns"));
